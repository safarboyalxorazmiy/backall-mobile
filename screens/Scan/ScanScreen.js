    ...
    return (
        <>
            <View style={styles.container}>
                <View style={{width: screenWidth - (16 + 16), display: "flex", flexDirection: "row", alignItems: "center", marginBottom: 16 }}>
                ...
                <View style={{marginTop: 50, display: "flex", alignItems: "center"}}>
                    <Text style={{fontSize: 16, fontFamily: "Gilroy-SemiBold", fontWeight: 600, marginBottom: 12}}>Shtrix kodni kameraga tuting</Text>

                    <View style={{backgroundColor: "#D9D9D9", height: 412, width: screenWidth - 16 - 16, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: 4}}>
