...
class Home extends Component {
	...
	async getSellHistories() {
		...
		let response;
		try {
			response = await this.apiService.getSellHistories(
				lastSellHistoryGlobalId, page, size, this.props.navigation
			);
		} catch (error) {
			console.error("Error fetching global products:", error);
			this.setState({
	...
	async getSellHistoryGroup() {
		...
		let response;
		try {
			response = await this.apiService.getSellHistoryGroup(lastSellHistoryGroupGlobalId, page, size, this.props.navigation);
		} catch (error) {
			console.error("Error fetching global products:", error);
			this.setState({
				lastSize: size,
	...
	async getProfitHistories() {
		...
		let response;
		try {
			response = await this.apiService.getProfitHistories(
				lastProfitHistoryGlobalId, page, size, this.props.navigation
			);
		} catch (error) {
			console.error("Error fetching global products:", error);
			this.setState({
	...
	async getProfitHistoryGroup() {
		...
		let response;
		try {
			response = await this.apiService.getProfitHistoryGroup(
				lastProfitHistoryGroupGlobalId, page, size, this.props.navigation
			);
		} catch (error) {
			console.error("Error fetching global products:", error);
			this.setState({
